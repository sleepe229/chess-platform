...
public class NatsConfig {
    ...
    private void initializeStreams(Connection connection) {
        try {
            ...
            log.warn("Failed to initialize JetStream streams (auth-service). NATS will still run without persistence.", e);
        }
    }

    private void ensureStream(JetStreamManagement jsm, String streamName, String[] subjects) throws IOException, JetStreamApiException {
        boolean exists;
        try {
        ...
        try {
            ...
            // race: another service created it
