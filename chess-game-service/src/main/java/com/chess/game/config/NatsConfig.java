...
public class NatsConfig {
    ...
    @Value("${nats.connection-name:game-service}")
    ...
    private void initializeStreams(Connection connection) {
        try {
            ...
            ensureStream(jsm, NatsSubjects.STREAM_MATCHMAKING, new String[]{NatsSubjects.MATCHMAKING_MATCH_FOUND});
            ...
            log.warn("Failed to initialize JetStream streams (game-service). NATS will still run without persistence.", e);
        }
    }
